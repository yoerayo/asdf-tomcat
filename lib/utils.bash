...
# NOTE: You might want to remove this if tomcat is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if tomcat has other means of determining installable versions.
  list_github_tags
}
...
install_version() {
  ...
  (
    ...
    # TODO: Asert tomcat executable exists.
    local tool_cmd
